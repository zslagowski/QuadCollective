...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header qc-header-single-blog">
		<?php
		if ( is_single() ) :
		...
		<div class="qc-feature-image-single-blog text-center"><?php the_post_thumbnail(); ?></div>

		<?php if ( 'post' === get_post_type() ) : ?>
		<div class="entry-meta qc-entry-meta-single-blog">
	...
	<div class="entry-content qc-entry-content-single-blog">
		<?php
			the_content( sprintf(
